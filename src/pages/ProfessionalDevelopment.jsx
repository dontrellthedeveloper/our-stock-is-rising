                            ...
                            <div className="col-md-10 col-sm-10" style={{display: 'table'}}>
                                <div className="about-right" style={{display: 'table-cell', verticalAlign: 'middle'}}>
                                    <div className="horizontal-heading main-about" style={{color: '#000'}}>
                                        <h5 style={{color: '#000'}}>Learn About</h5>
                                        <h2> <strong ></strong>Professional <br/> Development</h2>
                                    </div>
...
Welcome to the Professional Development Page, the central destination for all the tools, resources, and training sessions to bring Our Stock Is Rising into your classroom! This page is under construction so stay tuned! </p>
